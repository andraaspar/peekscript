...
test(`[rgtbdf]`, () => {
	const it = new Decimal(123n, 2).toDecimalPlaces(1)
...
test(`[rgtc9f]`, () => {
	const it = new Decimal(125n, 2).toDecimalPlaces(1)
...
test(`[rgtc7f]`, () => {
	const it = new Decimal(295n, 2).toDecimalPlaces(1)
...
test(`[rgtip8]`, () => {
	const it = new Decimal(666n, 3).toDecimalPlaces(2)
